...
Notes for the YearUp Pittsburgh Fall 2023 Cohort

## Applications

- [Git](./git/0-git-index.md)
- [Visual Studio Code](./setup/vscode-config.md)
...
- [Breaks](./admin/breaks.md)
- [Standup Meeting](./admin/standups.md)
